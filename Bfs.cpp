...
// Algorithme de recherche: Parcour la meilleur d'abord 
// En case: 2 seaus
void dfs2() {
    ...
    while (!nodeStack.empty()) {// programe exécute jusqu'au la pile est vide 
        ...
        // D'abord, gère les 2 fils 'fill' possibles
...
// Algorithme de recherche: Parcour en largeur d'abord 
// En cas: 3 seaus
void dfs3() {
    std::stack<state> nodeStack; // créer la pile de recherche 
    state tmp;
    ...
    while (!nodeStack.empty()) {// programe exécute jusqu'au la pile est vide 
        ...
        // d'abord, gère les trois fils 'fill' possibles
...
void dfs6() {
    ...
    while (!nodeStack.empty()) {// programe exécute jusqu'au la pile est vide 
        ...
        // d'abord, gère les 6 fils 'fill' possibles
...
{   
	...
	std::cout << " WELCOM TO WATER JUG PROBLEM WITH BREADTH FIRST SEARCH \n\n";
